...
export default function TechStackSection({ data }) {
  ...
  const categories = techStackSection.categories || fallbackData.techStackSection.categories;
  const [activeCategory, setActiveCategory] = useState(categories[0]?.id || 'product-engineering');
  ...
  return (
    <section className="md:my-16 my-8 overflow-hidden">
      <div className="max-w-[1800px] mx-auto md:w-[90%] w-full sm:px-0 px-4 md:px-0">
        ...
        >
          <p className="font-normal text-[#0f2b48] md:text-5xl text-2xl mb-4">
            ...
            <span className="text-[#04A552] md:text-5xl text-2xl font-semibold">
